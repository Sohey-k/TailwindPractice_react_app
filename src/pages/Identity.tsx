...
const sections: Section[] = [
  {
    title: "自己紹介",
    content:
      "こんにちは、Sohey-Kです。15年間の通信インフラ業務経験を経て、エンジニアとして活動しています。直近では、大規模複合施設にて10ヶ月間、Juniper機器（SRX4200、MX240、EX4650）を用いたVXLAN/EVPN環境の運用に従事し、700台以上の無線APをJuniper MIST経由で管理していました。AWS Solutions Architect Associate、JNCIA-Junos、CCNA、LPIC-2などの資格を保有し、インフラ自動化とクラウド技術を軸にキャリアを構築中です。現在、インフラエンジニア・SREポジションを中心に次のキャリアを探しています。",
  },
  {
    title: "REARMEの由来",
    content:
